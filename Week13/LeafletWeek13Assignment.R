...
#Longitude is first, latitude is second. Therefore longitude is the x-axis and latitude is the y-axis.
...
# It gives a little menu in the top right corner.
...
# The one without clustering is good for seeing every individual marker, but can quickly become overcrowded. This is where clustering comes in handy.
